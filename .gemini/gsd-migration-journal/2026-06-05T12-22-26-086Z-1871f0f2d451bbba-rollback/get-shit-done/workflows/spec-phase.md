...
```bash
INIT=$(node "C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/get-shit-done/templates/spec.md.

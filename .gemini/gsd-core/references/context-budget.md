...
The keys live in `.claude/settings.json` (project) or `C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/settings.json` (global) — **not** in `.planning/config.json`:

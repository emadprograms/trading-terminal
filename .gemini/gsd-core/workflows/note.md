...
- **Global scope**: `C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/notes/`)
...
2. Glob `C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/notes/` — works in any directory

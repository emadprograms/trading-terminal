...
```bash
INIT=$(node "C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Emad/Documents/GitHub/trading-terminal/.gemini/gsd-core/bin/gsd-tools.cjs" commit \
